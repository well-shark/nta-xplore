# Network Traffic Analysis - Xplore

> 用于跟踪**加密趋势**和**网络流量分析**研究的最新进展
>
> Network traffic analysis reports, academic papers, etc.



## 学术论文 / Conferences & Journals
...
- dblp: https://dblp.uni-trier.de/db/conf/ndss/index.html
...
![ccfa](https://img.shields.io/badge/CCF-A-blue) ![if](https://img.shields.io/badge/IF-6.8-green)

- Issues: https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=10206



#### ToN: IEEE/ACM Transactions on Networking
![ccfa](https://img.shields.io/badge/CCF-A-blue) ![if](https://img.shields.io/badge/IF-3.7-green)

- Issues: https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=90



#### TDSC: IEEE Transactions on Dependable and Secure Computing
![ccfa](https://img.shields.io/badge/CCF-A-blue) ![if](https://img.shields.io/badge/IF-7.3-green)
...
![ccfb](https://img.shields.io/badge/CCF-B-blue) ![if](https://img.shields.io/badge/IF-5.6-green)

- Issues: https://www.sciencedirect.com/journal/computer-networks/issues
...
- Issues: https://www.sciencedirect.com/journal/computers-and-security/issues
...
![ccfb](https://img.shields.io/badge/CCF-B-blue) ![if](https://img.shields.io/badge/IF-3.7-green)

- Volumes and issues: https://link.springer.com/journal/11280/volumes-and-issues



#### The Computer Journal
![ccfb](https://img.shields.io/badge/CCF-B-blue) ![if](https://img.shields.io/badge/IF-1.4-green)

- Issues: https://academic.oup.com/comjnl/issue



#### IOT: IEEE Internet of Things Journal
![ccfc](https://img.shields.io/badge/CCF-C-blue) ![if](https://img.shields.io/badge/IF-10.6-green)

- dblp: https://dblp.org/db/journals/iot/index.html



#### CC: Computer Communications
![ccfc](https://img.shields.io/badge/CCF-C-blue) ![if](https://img.shields.io/badge/IF-6-green)
...
![ccfc](https://img.shields.io/badge/CCF-C-blue) ![if](https://img.shields.io/badge/IF-5.3-green)
...
![ccfc](https://img.shields.io/badge/CCF-C-blue) ![if](https://img.shields.io/badge/IF-3.1-green)

- dblp: https://dblp.unitrier.de/db/journals/cybersec/index.html
...
![ccfc](https://img.shields.io/badge/CCF-C-blue) ![if](https://img.shields.io/badge/IF-0-green)
...
#### 全球数字化报告 / Digital Around The World

https://datareportal.com/global-digital-overview

- 全球网民规模 / Internet use around the world
- 社交媒体使用情况统计 / Essential social media stats
- 全球移动网络数据统计 / Mobile stats from around the world
- 各国家/地区数字化报告 / Reports by region/countries
...
#### 谷歌透明度报告 - 网络上的 HTTPS 加密 / Google Transparency Report - HTTPS encryption on the web

https://transparencyreport.google.com/https/overview

- 所有 Google 产品和服务中的已加密流量 (Encrypted traffic across Google)
- 向 Google 提交的加密请求数（全球） (Encrypted requests to Google worldwide)
- Chrome 中的 HTTPS 加密情况（按平台） (HTTPS Encryption by Chrome platform)
  - Chrome 中通过 HTTPS 加载的网页所占的百分比（按平台） (Percentage of pages loaded over HTTPS in Chrome by platform)
  - Chrome 中的 HTTPS 浏览时间所占的百分比（按平台） (Percentage of HTTPS browsing time by Chrome platform)
- Chrome 中的 HTTPS 使用情况（全球） (HTTPS usage in Chrome worldwide)
  - Chrome 中通过 HTTPS 加载的网页所占的百分比（按国家/地区） (Percentage of pages loaded over HTTPS in Chrome by country/region)
  - Chrome 中的 HTTPS 浏览时间所占的百分比（按国家/地区） (Percentage of HTTPS browsing time in Chrome by country/region)
- 各大热门网站的 HTTPS 实施情况 (HTTPS on top sites)
  - 默认使用 HTTPS 的网站 (Sites that default to HTTPS)
  - 支持 HTTPS 的网站 (Sites that work on HTTPS)
...
- 清华个人主页（论文更新不及时）：https://netsec.ccert.edu.cn/people/qli/
- 个人主页：https://sites.google.com/site/qili2012



### 浙江大学 - 纪守领

- 网络系统安全与隐私实验室（NESA Lab）：https://nesa.zju.edu.cn/index.html
